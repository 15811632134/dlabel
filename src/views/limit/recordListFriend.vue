<template>
  <div class="recordListFriend">
    <div class="app-menu" style="margin-top:0px">
      <div class="app-menu">
        <h3>我的友商（{{ companys.length }}）</h3>
        <ul>
          <li
    ...
    <div class="rigth-content">
      ...
      >
        ...
        <div class="selectPartner " style="margin-left:80px">
            <label>操作类型：</label>
            <el-select
      ...
      >
        ...
        >
          ...
          <el-form-item label="问题类型：">
            <el-select filterable v-model="ruleForm.type" placeholder="请选择SDK">
...
export default {
      ...
      pickerOptionsBack: {
        disabledDate(time) {
          return (
            ...
            time.getTime() <= Date.now() - 24 * 60 * 60 * 1000 * 365
          );
        }
      },
      totalnumber: 0,
      ...
      msgings: [
        {
          id: 0,
          name:
            '您好，已收到您的反馈，您反馈的问题我们已经列入更新计划中，在未来更新...'
        },
        {
          id: 1,
          name:
            '您好，您反馈的打印问题可以先和您的打印机厂家或客服联系，确保您的打印...'
        },
        {
          id: 2,
          name:
            '您好，您反馈的搜索不到打印机蓝牙问题我们已收到，再确认手机蓝牙是否已...'
        },
        {
          id: 3,
          name:
            '您好，您反馈的以前编辑的模板更新软件后再打开内容有错位问题我们已收到...'
        }
      ],
  ...
  created() {
    ...
    this.listapi = companyoperatelogList;
  ...
  methods: {
    ...
    handleDownload() {
      ...
      for (let i = 0; i < this.selectExcelData.length; i++) {
        if (this.selectExcelData[i].id) {
          this.selectExcelData[i].operateTime = moment(
            this.selectExcelData[i].operateTime
    ...
    getList() {
      ...
      companyoperatelogList(this.listQuery).then(res => {
...
.echarts-time {
  ...
  /deep/.echarts-date .el-date-editor{
    height: 32px;
  }
  em{
    top:6px;
