  ...
  <div class="createCompany">
    ...
    >
      <el-form-item label="公司名称" prop="fullName">
        <el-checkbox v-show="noPress" v-model="fullNameCheck" class="companyCheck" maxlength="50"/>
        <textarea
          :readonly="ruleForm.status != 0"
      ...
      <el-form-item label="公司简称" prop="shortName">
        <el-input v-model="ruleForm.shortName" :readonly="ruleForm.status != 0" maxlength="50" placeholder="请输入公司简称"/>
      </el-form-item>
      <el-form-item label="联系人" prop="contactName">
        <el-input v-model="ruleForm.contactName" maxlength="50" placeholder="请输入联系人"/>
      </el-form-item>
      <el-form-item label="联系电话" prop="contactPhone">
        <el-checkbox v-show="noPress" v-model="phoneCheck" class="companyCheck" maxlength="50"/>
        <div class="m_clearLR">
          <div class="m_floatL">
            <el-input v-model="ruleForm.contactPhone" maxlength="50" placeholder="请输入联系电话"/>
          </div>
          <!-- <div class="m_floatL m_clearLR" style="margin-left:64px;">
            <div style="margin-right:16px;color:#666;" class="m_floatL">固定电话:</div>
            <div class="m_floatL">
              <el-input placeholder="请输入固定电话" v-model="ruleForm.fixedTelephone"></el-input>
            </div>
          </div> -->
        </div>
      </el-form-item>
      <el-form-item label="邮箱" prop="contactEmail">
        <el-input v-model="ruleForm.contactEmail" maxlength="50" placeholder="请输入邮箱"/>
      </el-form-item>
      <el-form-item label="近三年平均年营业额" prop="contactEmail">
        <el-select v-model="ruleForm.turnover" placeholder="近三年平均年营业额" @change="choseBlock">
          <el-option v-for="(item,index) in turnoverArr" :key="index" :label="item" :value="item"/>
        </el-select>
      </el-form-item>
      <el-form-item label="正在销售的打印硬件品牌" prop="sale_label_brand">
        <el-input v-model="ruleForm.sale_label_brand" maxlength="50" placeholder="请输入正在销售的打印硬件品牌"/>
      </el-form-item>
      <el-form-item label="合作意向描述" prop="cooper_intention">
        <el-input
          v-model="ruleForm.cooper_intention"
          type="textarea"
          placeholder="请输入合作意向描述"
          maxlength="300"/>
      </el-form-item>
      <el-form-item ref="againValue1" label="公司Logo">
        <div class="m_clearLR">
          <div class="m_floatL imgHiddenDiv">
            <div class="imgUpload" @click="logoChange">
              <i v-if="!ruleForm.logoImg" class="iconfont icontianjiatupian"/>
              <img v-else :src="ruleForm.logoImg" >
              <input
                type="file"
                style="display:none"
                accept=".png,.jpg,.jpeg"
      ...
      <!-- <el-form-item label="统一社会信用代码" prop="organizationCode">
        ...
        <el-input :readonly="ruleForm.status != 0" v-model="ruleForm.organizationCode" maxlength="18" placeholder="统一社会信用代码"></el-input>
      </el-form-item> -->
      <el-form-item ref="againValue2" label="公司营业执照" prop="threeImg">
        <el-checkbox v-show="noPress" v-model="threeCheck" class="companyCheck"/>
        <div class="m_clearLR">
          <div class="m_floatL imgHiddenDiv">
            <div class="imgUpload threeImg" @click="threeChange">
              <i v-if="!ruleForm.threeImg" class="iconfont icontianjiatupian"/>
              <img v-else :src="ruleForm.threeImg" >
              <input
                type="file"
                style="display:none"
                accept=".png,.jpg,.jpeg"
            ...
            <div v-if="ruleForm.threeImg" class="imgHiddenBox">
              <svg :class="ruleForm.applyStatus == 3?'threei3':''" t="1572834051347" class="icon threei1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1836" width="32" height="32" @click="openImg(ruleForm.threeImg)"><path d="M483.027256 868.173913a422.956522 422.956522 0 1 0 0-845.913043 422.956522 422.956522 0 0 0 0 845.913043z m0-44.521739a378.434783 378.434783 0 1 1 0-756.869565 378.434783 378.434783 0 0 1 0 756.869565z" fill="#FFFFFF" p-id="1837"/><path d="M673.371564 782.738317m15.463699-16.013129l0 0q15.463699-16.013129 31.476829-0.54943l224.183813 216.491791q16.013129 15.463699 0.54943 31.476829l0 0q-15.463699 16.013129-31.476829 0.54943l-224.183813-216.491792q-16.013129-15.463699-0.54943-31.476828Z" fill="#FFFFFF" p-id="1838"/><path d="M260.41856 422.956522m22.26087 0l400.695652 0q22.26087 0 22.260869 22.260869l0 0q0 22.26087-22.260869 22.26087l-400.695652 0q-22.26087 0-22.26087-22.26087l0 0q0-22.26087 22.26087-22.260869Z" fill="#FFFFFF" p-id="1839"/><path d="M505.288125 222.608696m0 22.260869l0 400.695652q0 22.26087-22.260869 22.26087l0 0q-22.26087 0-22.26087-22.26087l0-400.695652q0-22.26087 22.26087-22.260869l0 0q22.26087 0 22.260869 22.260869Z" fill="#FFFFFF" p-id="1840"/></svg>
              <svg v-if="ruleForm.applyStatus != 3" t="1572833416147" class="icon threei2" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7815" width="32" height="32" @click="deleteImg('threeImg')"><path d="M381.952 24.380952h260.096a97.52381 97.52381 0 0 1 97.52381 97.52381v130.048H284.42819V121.904762a97.52381 97.52381 0 0 1 97.52381-97.52381z m308.857905 97.52381a48.761905 48.761905 0 0 0-48.761905-48.761905H381.952a48.761905 48.761905 0 0 0-48.761905 48.761905v81.286095h357.61981V121.904762z" fill="#ffffff" p-id="7816"/><path d="M113.761524 195.047619h796.476952l-64.365714 707.730286a97.52381 97.52381 0 0 1-97.133714 88.746666H273.944381a97.52381 97.52381 0 0 1-97.133714-88.892952L113.761524 195.047619z m53.296762 48.761905l58.319238 654.482286a48.761905 48.761905 0 0 0 48.566857 44.422095h474.794667a48.761905 48.761905 0 0 0 48.566857-44.373334L856.746667 243.809524H167.107048z" fill="#ffffff" p-id="7817"/><path d="M52.809143 195.047619h918.381714a24.380952 24.380952 0 0 1 24.380953 24.380952v8.143239a24.380952 24.380952 0 0 1-24.380953 24.380952H52.809143a24.380952 24.380952 0 0 1-24.380953-24.380952V219.428571a24.380952 24.380952 0 0 1 24.380953-24.380952zM327.92381 337.627429a28.42819 28.42819 0 0 1 29.891047 26.916571l23.844572 454.460952a28.42819 28.42819 0 1 1-56.807619 2.974477l-23.844572-454.460953a28.42819 28.42819 0 0 1 26.916572-29.891047zM512 337.286095c15.701333 0 28.42819 12.678095 28.42819 28.428191v455.094857a28.42819 28.42819 0 1 1-56.85638 0V365.714286c0-15.701333 12.678095-28.42819 28.42819-28.428191zM700.513524 337.92a28.42819 28.42819 0 0 1 26.38019 30.329905l-31.695238 453.973333a28.42819 28.42819 0 1 1-56.758857-3.900952l31.695238-454.022096a28.42819 28.42819 0 0 1 30.378667-26.428952z" fill="#ffffff" p-id="7818"/></svg>
            </div>
          </div>
          <div
      ...
      <el-form-item label="公司地址" prop="address">
        <el-input v-model="ruleForm.address" placeholder="请输入公司地址" class="companyAddress"/>
      </el-form-item>
      <!-- <el-form-item label="协议上传" prop="serverImg" ref="againValue3">
        <div class="m_clearLR">
          <div class="m_floatL imgHiddenDiv">
            ...
            <div class="imgHiddenBox" v-if="ruleForm.serverImg&&ruleForm.status == 0">
      ...
      <el-form-item v-if="noPress">
        <el-button type="primary" class="saveBtn m_search" @click="saveNoPress">保存</el-button>
        <div>备注：选中项需要友商重新录入</div>
      </el-form-item>
      <el-form-item v-else>
        <el-button type="primary" class="saveBtn m_search" @click="submitForm('ruleForm')">保存</el-button>
    ...
    <el-dialog :close-on-click-modal="false" :visible.sync="visibile" :title="title" class="dialog classifydialog" width="500px">
      <el-form
    ...
    <div v-show="showImgPath" class="showImage" @click="hiddenImage">
...
import {
  saveCompanyBase, uploadPic, update_company_info_by_company_code_revise, getCompanyInfo, company_apply_refuse_save,
  company_apply_success_save
} from '@/api/api'
...
export default {
  ...
  computed: {
    ...
    calcRuleForm() {
      if (this.ruleForm.cityCode) { this.ruleForm.cityCode = this.ruleForm.cityCode + '' }
      if (this.ruleForm.areaCode) { this.ruleForm.areaCode = this.ruleForm.areaCode + '' }
  ...
  methods: {
    ...
    getCompanyInfo(id) {
      getCompanyInfo({ company_code: id }).then(res => {
        if (res.code == 100) {
          var temp = res.data
          // temp.provinceCode =  res.data.provinceCode+'';
          // this.choseProvince(temp.provinceCode)
          // temp.cityCode =  res.data.cityCode+'';
          // this.choseCity(temp.cityCode)
          // temp.areaCode =  res.data.areaCode+'';
          console.log('res.data')
          console.log(res.data)
          temp.sale_label_brand = res.data.saleLabelBrand
          temp.cooper_intention = res.data.cooperIntention
          temp.logoImg = res.data.imageLogo && res.data.imageLogo.sourceUrl
          temp.imageLogo = res.data.imageLogo ? res.data.imageLogo : { id: '' }
          temp.threeImg = res.data.imageBusinessPhoto && res.data.imageBusinessPhoto.sourceUrl
          // temp.serverImg = res.data.imageDealPhoto.sourceUrl;
          this.ruleForm = temp
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          update_company_info_by_company_code_revise(temp).then(res => {
            if (res.code == 100) {
